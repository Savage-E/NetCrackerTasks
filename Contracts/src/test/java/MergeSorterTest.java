...
public class MergeSorterTest {
  ...
  public void whenSortByIdThenArraySorted() {
    ...
    array.add(new DigitalTvContract(31,
    ...
    array.add(new DigitalTvContract(1,
            new LocalDate(2010, 12, 12, CopticChronology.getInstance()),
            new LocalDate(2010, 12, 21, CopticChronology.getInstance()),
    ...
    array.add(new DigitalTvContract(5,
            new LocalDate(2010, 12, 12, CopticChronology.getInstance()),
            new LocalDate(2010, 12, 21, CopticChronology.getInstance()),
    ...
    array.add(new CellularContract(2,
            new LocalDate(2010, 12, 12, CopticChronology.getInstance()),
            new LocalDate(2010, 12, 21, CopticChronology.getInstance()),
    ...
    array.add(new DigitalTvContract(4,
            new LocalDate(2010, 12, 12, CopticChronology.getInstance()),
            new LocalDate(2010, 12, 21, CopticChronology.getInstance()),
    ...
    new MergeSorter().sort(array, Comparator.comparingInt(Contract::getId));
