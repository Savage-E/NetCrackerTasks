 ...
 * Merge Sorter.
 *
 * <p>Please see the {@link ISorter} interface for true identity
 *
 * @author Vlad Kotov
 */
public class MergeSorter implements ISorter<DynamicArray<Contract>, Contract> {
  ...
  private DynamicArray<Contract> merge(final DynamicArray<Contract> left,
                                       final DynamicArray<Contract> right,
